                ...
                t.exports = (function () {
                    ...
                    function _(t, i, e, o, s, n, r) {
                        ...
                        return (
                            ...
                            f < o
                                ? ((f = n
                                      ? Math.max(o - n / 4, o - (n / m) * l)
                                      : o),
                                  (u = d))
                                : s < f &&
                                  ((f = n
                                      ? Math.min(s + n / 4, s + (n / m) * l)
                                      : s),
                                  (u = d)),
                    ...
                    function C(t, i) {
                        ;(this.wrapper =
                            'string' == typeof t
                                ...
                                : t),
                            this.wrapper ||
                                W('Can not resolve the wrapper DOM.'),
                    ...
                    return (
                        ...
                        (k.prototype._handleOptions = function (t) {
                            ;(this.options = l({}, M, t)),
                                (this.translateZ =
                                    this.options.HWCompositing && v
                                        ? ' translateZ(0)'
                                        : ''),
                                (this.options.useTransition =
                                    this.options.useTransition && y),
                                (this.options.useTransform =
                                    this.options.useTransform && w),
                                ...
                                (this.options.freeScroll =
                                    this.options.freeScroll &&
                                    !this.options.eventPassthrough),
                                (this.options.directionLockThreshold = this
                        ...
                        (k.prototype._handleDOMEvents = function (t) {
                            var i = this.options.bindToWrapper
                                ? this.wrapper
                                : window
                            t(window, 'orientationchange', this),
                                t(window, 'resize', this),
                                this.options.click &&
                                    t(this.wrapper, 'click', this, !0),
                        ...
                        (L.prototype._checkClick = function (t) {
                            ...
                            if (this.options.wheel) {
                                if (
                                    ...
                                    var a = Math.abs(
                                            Math.round(this.y / this.itemHeight)
                                        ),
                                        l = Math.round(
                                            (this.pointY +
                                                ((s = this.wrapper),
                        ...
                        (L.prototype._transitionTime = function () {
                            var t =
                                0 < arguments.length && void 0 !== arguments[0]
                                    ...
                                    : 0
                            if (
                                ((this.scrollerStyle[x.transitionDuration] =
                                    t + 'ms'),
                                this.options.wheel)
                            )
                                for (var i = 0; i < this.items.length; i++)
                                    this.items[i].style[x.transitionDuration] =
                                        t + 'ms'
                            if (this.indicators)
                        ...
                        (L.prototype._transitionTimingFunction = function (t) {
                            ...
                            if (this.indicators)
                                for (var e = 0; e < this.indicators.length; e++)
                                    this.indicators[e].transitionTimingFunction(
                                        t
                                    )
                        }),
                        ...
                        (L.prototype._translate = function (t, i, e) {
                            if (
                                ...
                                for (
                                    ...
                                    this.items[n].style[x.transform] =
                                        'rotateX(' + r + 'deg)'
                                }
                            if (
                                ((this.x = t),
                        ...
                        (L.prototype.scrollToElement = function (
                            t,
                            i,
                            e,
                            o,
                        ...
                        (H.prototype._onMouseWheel = function (t) {
                            ...
                            if (this.enabled) {
                                ...
                                ;(p =
                                    this.x +
                                    Math.round(
                                        this.hasHorizontalScroll ? h : 0
                                    )),
                                    (u =
                                        this.y +
                                        Math.round(
                                            this.hasVerticalScroll ? c : 0
                                        )),
        ...
        (i.prototype = {
            ...
            createUI: function () {
                for (
                    ...
                    if (
                        ((e +=
                            '<div id="' + a[s] + '"><ul class="wheel-scroll">'),
                        'YYYY' == s)
                    )
                        ...
                        s = function (t) {
                            ...
                            ;(o.endX = i.pageX),
                                ...
                                +new Date() - o.sTime < 300 &&
                                    Math.abs(o.endX - o.startX) +
                                        Math.abs(o.endY - o.startY) <
                                        20 &&
