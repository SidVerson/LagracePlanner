...
// Устанавливаем класс "active" и сохраняем значение в localStorage при загрузке страницы
if (isActive) {
...
eventsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("event")) {
      ...
      console.log('ABOBAAAAAAAAAAAAAAA', e.target)
      const eventActive = e.target.classList.contains('active')
      if(!eventActive){
        e.target.classList.add('active')
